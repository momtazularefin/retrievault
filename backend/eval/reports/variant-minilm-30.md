...
- Date: 2026-09-17T20:13:35Z
- Corpus: fastapi/fastapi @ 0.136.3 (838 chunks, chunker v2)
- Dataset: v1.1, 45 answerable questions
- Fused candidates: 30; selected: top 6; reranker: `Xenova/ms-marco-MiniLM-L-6-v2`
...
| File, selected | 0.78 | 0.93 | 0.98 | 0.86 |
| Symbol, fused | 0.82 | 0.91 | 0.98 | 0.88 |
| Symbol, selected | 0.67 | 0.89 | 0.98 | 0.78 |

- Gold file present in the fused top 30: 1.00
- Mean code sent to the model: 4812 characters
- P50 retrieve: 0.10 s; P50 rerank: 2.10 s
